...
export default function Footer() {
  ...
  const features = [
    { name: "Real-Time Prediction", path: "/model" },
    { name: "Weather Auto Fetch", path: "/model" },
    { name: "Appliance Prediction", path: "/appliance" },
    { name: "Secure Login System", path: "/login" },
            ...
            <div className="flex flex-col gap-2">
              {features.map((f) => (
                <Link
                  ...
                  className="flex items-center gap-2 text-xs text-slate-400 hover:text-blue-600 transition-colors group"
                >
                  <span className="w-1.5 h-1.5 rounded-full bg-blue-200 flex-shrink-0 group-hover:bg-amber-400 transition-colors" />
                  {f.name}
                </Link>
              ))}
            </div>
              ...
              {[
                {
                  ...
                  link: "mailto:electraforecast@gmail.com",
                },
                {
                  icon: Phone,
                  label: "Phone",
                  value: "+91 9749517191",
                  link: "tel:+919749517191",
                },
                {
                  icon: MapPin,
                  label: "Location",
                  value: "Punjab, India",
                  link: "https://www.google.com/maps?q=Punjab,India",
                },
