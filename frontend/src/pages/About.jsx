...
//       <div className="max-w-5xl mx-auto px-6 pt-20 pb-20 space-y-16">

//         {/* HERO */}
//         <div className="text-center pt-6">
//           <span className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-blue-50 border border-blue-200 text-blue-700 text-xs font-bold tracking-widest uppercase mb-5">
...
//               <div
//                 key={t.label}
//                 className={`border rounded-xl p-4 hover:shadow-md transition-shadow ${t.color}`}
//               >
...
//                   </div>
//                   <span className="text-4xl font-extrabold text-slate-100 select-none">{num}</span>
//                 </div>
...
//             {benefits.map((b) => (
//               <div key={b} className="flex items-center gap-3 p-3 rounded-xl bg-emerald-50 border border-emerald-100">
...
//               </div>
//               <h2 className="text-xl font-bold">Project Goal</h2>
//             </div>
